package kpan.kuso_diamod.block;

import kpan.kuso_diamod.ModMain;
import kpan.kuso_diamod.block.item.ItemBlockBase;
import kpan.kuso_diamod.block.item.ItemBlockVariants;
import kpan.kuso_diamod.item.ItemInit;
import kpan.kuso_diamod.util.PropertyUtil;
