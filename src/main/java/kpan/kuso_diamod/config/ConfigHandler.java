...
import kpan.kuso_diamod.config.ConfigAnnotations.BooleanValue;
import kpan.kuso_diamod.config.ConfigAnnotations.Comment;
import kpan.kuso_diamod.config.ConfigAnnotations.DoubleValue;
import kpan.kuso_diamod.config.ConfigAnnotations.EnumValue;
import kpan.kuso_diamod.config.ConfigAnnotations.FloatValue;
import kpan.kuso_diamod.config.ConfigAnnotations.IntValue;
import kpan.kuso_diamod.config.ConfigAnnotations.LongValue;
import kpan.kuso_diamod.config.ConfigAnnotations.Name;
import kpan.kuso_diamod.config.ConfigAnnotations.StringValue;
